            ...
            if (
                ...
                for quote in data["QuoteResponse"]["QuoteData"]:
                    ...
                    if (
                        ...
                        print(
                            "Today's Change: "
                            + str("{:,.3f}".format(quote["All"]["changeClose"]))
                            + " ("
                    ...
                    if (
                        ...
                        print(
                            "Open: " + str("{:,.2f}".format(quote["All"]["lastTrade"]))
                        )
                    if (
                        quote is not None
                        and "All" in quote
                        ...
                        print(
                            "Previous Close: "
                            + str("{:,.2f}".format(quote["All"]["previousClose"]))
                        )
                    if (
                        quote is not None
                        and "All" in quote
                        ...
                        print(
                            "Bid (Size): "
                            + str("{:,.2f}".format(quote["All"]["bid"]))
                            + "x"
                            + str(quote["All"]["bidSize"])
                        )
                    if (
                        quote is not None
                        and "All" in quote
                        ...
                        print(
                            "Ask (Size): "
                            + str("{:,.2f}".format(quote["All"]["ask"]))
                            + "x"
                            + str(quote["All"]["askSize"])
                        )
                    if (
                        quote is not None
                        and "All" in quote
                    ...
                    if (
                        ...
                        print(
                            "Volume: " + str("{:,}".format(quote["All"]["totalVolume"]))
                        )
            else:
                # Handle errors
                if (
